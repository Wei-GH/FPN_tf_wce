...
DATASET_NAME = 'occupation'  # 'ship', 'spacenet', 'pascal', 'coco'
PIXEL_MEAN = [90.456, 70.845, 50.51]  # R, G, B. In tf, channel is RGB. In openCV, channel is BGR
# 90.45597062606933 70.8453688449829 50.51613528928895
